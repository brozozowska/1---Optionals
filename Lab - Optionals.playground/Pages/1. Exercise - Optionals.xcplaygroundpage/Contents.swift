...
print(userAge)
print("Если значение не может быть передано в переменную, переменная остаётся пустой — nil")
/*:
...
if let unwrappedUserAge = userAge {
    print("userAge is \(unwrappedUserAge)")
} else {
    print("userAge doesn't have any value")
}
/*:
